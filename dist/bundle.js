...
/***/ function(module, exports, __webpack_require__) {
	...
	var _friends = __webpack_require__(159);
	...
	var _second = __webpack_require__(221);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { path: '/', component: Main },
	    _react2.default.createElement(_reactRouter.Route, { path: '/sam', pushTo: parent.pushToState, component: _friends2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/user', pushTo: 77, component: _second2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/user/:occupation', pushTo: 77, component: Occupation })
	  )
	), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = function (_React$Component) {
		...
		_createClass(List, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'hover1', onClick: this.handleClick.bind(this) },
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: "/user/" + this.props.email },
						_react2.default.createElement(
							'div',
							{ className: 'de' },
							this.props.email
						...
						_react2.default.createElement(
							'div',
							{ className: 'ret', style: { width: parseInt(this.props.salary.slice(1)) * 3 + 'px' } },
							this.props.salary
						)
					)
				);
	...
	var FriendsContainer = function (_React$Component2) {
		_inherits(FriendsContainer, _React$Component2);

		function FriendsContainer(props) {
			_classCallCheck(this, FriendsContainer);

			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(FriendsContainer).call(this, props));
		...
		_createClass(FriendsContainer, [{
			...
			value: function componentDidMount() {
				...
				fetch('https://gist.githubusercontent.com/samosale/bc0920114e48c1ccccef/raw/d80f635e60ecb9a3680cdb8f9bb6f52ee638e6f6/gistfile1.json').then(function (response) {

					return response.json();
				}).then(function (json) {
					console.log('parsed json', json);
					window.cached = json;
					_this3.setState({ friends: json,
			...
			value: function render() {
				...
				var friends = this.state.friends.sort(function (a, b) {
					...
					return _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(List, { key: ind, pushToPar: this.props.pushTo, email: val['COL 1'], salary: val['COL 9'].replace(/>=/i, ''), index: ind, name: this.props.name, handleClick: this.handleClick })
					);
				}, this);
		...
		_createClass(Results, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ style: { animationDelay: this.props.index * 100 + 'ms' }, className: 'display fadeDesno' },
						_react2.default.createElement(
							'div',
							{ className: 'time font' },
							' ',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ target: '_blank', href: '', className: 'font' },
								'MIT'
							)
						)
					)
